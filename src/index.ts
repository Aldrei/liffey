...
/** Routes */
import { bannerRoutes, cityRoutes, messageRoutes, neighborhoodRoutes, ownerRoutes, propertiesAgenciesRoutes, propertyPhotosRoutes, propertyRoutes, subscriptionPaymentRoutes, userRoutes, videosRoutes } from '@/routes/api/rest/guard';
...
const starter = async () => {
  ...
  app.use(subscriptionPaymentRoutes.default)
